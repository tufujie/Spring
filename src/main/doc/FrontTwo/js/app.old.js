...
var App = function() {
    ...
    var uiInit = function() {
        ...
        $('.input-datepicker, .input-daterange').datepicker({weekStart: 1,language: 'zh'});
        $('.input-datepicker-close').datepicker({weekStart: 1,language: 'zh'}).on('changeDate', function(e){ $(this).datepicker('hide'); });
